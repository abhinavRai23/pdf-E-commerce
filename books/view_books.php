                    ...
                    <?php
                        ...
                        if($rows!=0)
                        {
                            for ($j = 0 ; $j < $rows ; ++$j)
                            {
                                ...
                                <tr>
                                    <td>'.($j+1).'</td>
                                    <td><img style="width:100%" src="/vinra/uploads/poster/'.$row["poster"].'" /></td> 
                                    <td>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/vinra/uploads/sample_pdf_book/'.$row["sample_pdf_book"].'" target="_blank">'.$row["sample_pdf_book"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>Book Link</td>
                                                    <td><a href="/vinra/uploads/pdf_book/'.$row["pdf_book"].'" target="_blank">'.$row["pdf_book"].'</td>
                                                </tr>
                                                <tr>
                                                    <td>Description</td>
                                                    <td>'.$row["book_desc"].'</td>
