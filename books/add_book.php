<?php
    ...
    function file_upload( $file, $file_name, $max_file_size){
        ...
        $target_dir = $_SERVER['DOCUMENT_ROOT'].'/vinra/uploads/';
...
<?php
    ...
    )
    {
        ...
        if($file_error==0){
            $query = "INSERT into bookes (title, author, isbn, poster, category_id, book_desc, published_date, sample_pdf_book, price, pdf_book, no_of_pages) values ( $title, $author, $isbn, $poster, $category_id, $book_desc, $published_date, $sample_pdf_book, $price, $pdf_book, $no_of_pages )";
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                <fieldset>
                    <div class="col-md-6 form-group">
                        Book title*:<input class="form-control" placeholder="Enter Book Title" value="You have only one friend and its yourself" name="title" type="varchar" required autofocus="on">
                    </div>
                    <div class="col-md-6 form-group">
                        Author*:<input class="form-control" placeholder="Author Name" value="Abhinav Rai" name="author" type="varchar" required>
                    </div>
                    <div class="col-md-6 form-group">
                        ISBN:<input class="form-control" placeholder="ISBN code" value="123456" name="isbn" type="number" required>
                    </div>
                    <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        Published Date*:<input class="form-control" placeholder="Published Date" value="2019-04-21" name="published_date" type="date" required>
                    </div>
                    <div class="col-md-6 form-group">
                        Book Price:<input class="form-control" placeholder="Enter Book Price" value="3999" name="price" type="float" required>
                    </div>
                    <div class="col-md-6 form-group">
                        No of Pages*:<input class="form-control" placeholder="Enter No of Pages" value="251" name="no_of_pages" type="varchar" required>
                    </div>
                    <div class="col-md-6 form-group">
                        Book Description: <textarea class="form-control" rows="3" placeholder="Enter book description" name="book_desc" required>It's a book to know yourself better.</textarea>
                    </div>
                    <div class="col-md-6 form-group">
